            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <p style={{ color: '#000' }}>Tìm kiến việc làm</p>
                    </div>
                    <div
                        style={{
                            padding: '10px',
                    ...
                    >
                        <img src="/path/to/image7.jpg" alt="Image 7" style={{ width: '100%', borderRadius: '5px' }} />
                        <p style={{ color: '#000' }}>Text for Image 7</p>
                    </div>
                    <div
                        style={{
                            padding: '10px',
                    ...
                    >
                        <img src="/path/to/image8.jpg" alt="Image 8" style={{ width: '100%', borderRadius: '5px' }} />
                        <p style={{ color: '#000' }}>Text for Image 8</p>
                    </div>
                </div>
            </div>
